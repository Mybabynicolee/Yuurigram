...
public class BuildVars {
    ...
    /**
     * Injected at build time from Gradle properties (TELEGRAM_API_ID / TELEGRAM_API_HASH).
     * Do not commit real credentials to source control.
     */
    public static int APP_ID = BuildConfig.YUURIGRAM_API_ID;
    public static String APP_HASH = BuildConfig.YUURIGRAM_API_HASH;

    // SafetyNet key for Google Identity SDK, set it to empty to disable
    public static String SAFETYNET_KEY = "";
    public static String PLAYSTORE_APP_URL = "https://play.google.com/store/apps/details?id=ja.yuurigram.org";
    ...
    public static boolean isBetaApp() {
        if (betaApp == null) {
            betaApp = ApplicationLoader.applicationContext != null && "ja.yuurigram.org.beta".equals(ApplicationLoader.applicationContext.getPackageName());
        }
        return betaApp;
    }
